...
int main(void){
	...
	std::cout << std::endl;
	{
		...
		FragTrap frag("lash_smash");
		std::cout << std::endl << "Tests for FragTrap functions" << std::endl << std::endl;
		std::cout << "lash_smash has " << frag.getHitPoints() << " hit points and " << frag.getEnergyPoints() << " energy points left" << std::endl;
		frag.takeDamage(takeDamage + 20);
		frag.attack("Bebop");
		frag.beRepaired(Heal + 5);
		frag.highFivesGuys();
		std::cout << "lash_smash has " << frag.getHitPoints() << " hit points and " << frag.getEnergyPoints() << " energy points left" << std::endl;
		std::cout << std::endl;
	}
